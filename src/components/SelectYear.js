          ...
          <Ionicons name="ios-basket" size={30} color="rgb(52,122,255)"/>
            ...
            <CardItem>
              ...
              <Right style={{paddingLeft:160}}>
                <TouchableOpacity
                    onPress={() => this.props.navigation.navigate('Showdata', {year: 4,interest: 2.5, percenToselectY: percen, price: price, payDownSibPer: payDownSibPer})}
                >
             ...
             <CardItem>
              ...
              <Right style={{paddingLeft:160}}>
                <TouchableOpacity
                    onPress={() => this.props.navigation.navigate('Showdata', {year: 5,interest: 3.0, percenToselectY: percen, price: price, payDownSibPer: payDownSibPer})}
                >
                    <Ionicons name="ios-arrow-forward-outline" size={30} color="rgb(52,122,255)"/>
                </TouchableOpacity>
              </Right>
             ...
             <CardItem>
              ...
              <Right style={{paddingLeft:160}}>
                <TouchableOpacity
                    onPress={() => this.props.navigation.navigate('Showdata', {year: 6,interest: 3.5, percenToselectY: percen, price: price, payDownSibPer: payDownSibPer})}
                >
                    <Ionicons name="ios-arrow-forward-outline" size={30} color="rgb(52,122,255)"/>
                </TouchableOpacity>
              </Right>
             ...
             <CardItem>
              ...
              <Right style={{paddingLeft:160}}>
                <TouchableOpacity
                    onPress={() => this.props.navigation.navigate('Showdata', {year: 7,interest: 4.0, percenToselectY: percen, price: price, payDownSibPer: payDownSibPer})}
                >
                    <Ionicons name="ios-arrow-forward-outline" size={30} color="rgb(52,122,255)"/>
                </TouchableOpacity>
              </Right>
